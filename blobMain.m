...
for i = 1:200
    ...
    closedBW = imclose(filledBW, strel('disk', 15));
    %blob detection using threshold area
    [dominosInImage, bbox] = getDominosInImage(closedBW, colorIm);
    [dominoValueImage, allCenters] = getDominoValues(BW, bbox, dominosInImage);
